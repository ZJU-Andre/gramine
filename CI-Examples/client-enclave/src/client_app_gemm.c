...
int main(int argc, char *argv[]) {
    ...
    printf("CLIENT_APP_GEMM_LOG: Encrypting input matrices A and B...\n");
    generate_iv(request_payload.iv_a, GCM_IV_SIZE_BYTES);
    int ret = libos_aes_gcm_encrypt(aes_key, request_payload.iv_a, (const unsigned char*)h_A, 
                                    request_payload.matrix_a_size_bytes,
                                    request_payload.masked_matrix_a, request_payload.tag_a, NULL, 0);
    ...
    ret = libos_aes_gcm_encrypt(aes_key, request_payload.iv_b, (const unsigned char*)h_B, 
                                    ...
                                    request_payload.masked_matrix_b, request_payload.tag_b, NULL, 0);
    ...
    printf("CLIENT_APP_GEMM_LOG: Decrypting result matrix C...\n");
    ret = libos_aes_gcm_decrypt(aes_key, response_payload->iv_c, 
                                response_payload->masked_matrix_c, response_payload->matrix_c_size_bytes,
